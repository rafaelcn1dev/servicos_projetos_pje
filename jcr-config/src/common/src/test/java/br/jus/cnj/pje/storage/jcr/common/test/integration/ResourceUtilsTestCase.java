package br.jus.cnj.pje.storage.jcr.common.test.integration;
...
public class ResourceUtilsTestCase {
	...
	@Test
	public void testRemoteSizeNotFound() throws IOException {
		long size = ResourceUtils.getResourceSize(getResourceURI("0000000000000000000000000000000000000000"), getHttpClient());
	...
	public static void setup() throws IOException {
		...
		config.load(ResourceUtilsTestCase.class.getResourceAsStream("/repository.properties"));
		// Configura conexao
