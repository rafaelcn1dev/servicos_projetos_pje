...
start wt -w "MinhaJanela" ^
  ...
  ; nt --title "PJE Front" -p "Prompt de Comando" cmd /k "cd /d C:\devTJPE\pje2-web && echo 'Nao esquecer de verificar o local onde esta o projeto do front-end! Ex:C:\devTJPE\pje2-web' && ng serve --host=0.0.0.0 --disable-host-check" ^
