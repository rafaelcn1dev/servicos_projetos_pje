...
set "JAVA_OPTS=-Xms1G -Xmx2G -XX:MetaspaceSize=512M -XX:MaxMetaspaceSize=1G -Dpje.producao=false -Dbr.jus.cnj.pje.jcr-storage.configuration=c:/dev/jcr/jcr-storage.properties -Dfile.encoding=UTF-8" 
