...
set "JAVA_OPTS=%JAVA_OPTS% -Dbr.jus.cnj.pje.jcr-storage.configuration=%USERPROFILE%\jcr\jcr-storage.local.properties"
...
echo ===============================================================================
echo.
echo   JBoss Bootstrap Environment - Rafael Cunha 1G
echo.
echo   JBOSS_HOME: "%JBOSS_HOME%"
echo.
echo   JAVA: "%JAVA%"
