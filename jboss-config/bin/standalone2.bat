...
rem Usage : standalone2.bat --debug
rem         standalone2.bat --debug 9797
...
if "x%STANDALONE_CONF%" == "x" (
   set "STANDALONE_CONF=%DIRNAME%standalone2.conf.bat"
)
...
rem properties para jcr
set "JAVA_OPTS=%JAVA_OPTS% -Dbr.jus.cnj.pje.jcr-storage.configuration=%USERPROFILE:\=/%/pje-binarios/pjebinarios-storage.properties"
...
if "x%JBOSS_BASE_DIR%" == "x" (
  set  "JBOSS_BASE_DIR=%JBOSS_HOME%\standalone2"
)
...
echo ===============================================================================
echo.
echo   JBoss Bootstrap Environment - Rafael Cunha 2G
echo.
echo   JBOSS_HOME: "%JBOSS_HOME%"
echo.
echo   JAVA: "%JAVA%"
